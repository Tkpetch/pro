<?php 
    ...
    if (isset($_REQUEST['update_id'])) {
        try {
            ...
            $select_stmt = $db->prepare('SELECT * FROM tbl_product WHERE p_id = :id');
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            $p_name = $_REQUEST['txt_name'];
            $p_detail = $_REQUEST['txt_detail'];
            $p_price = $_REQUEST['num_price'];
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $db->prepare("UPDATE tbl_product SET p_name = :name_up,p_detail = :detail_up,p_price = :price_up, image = :file_up WHERE p_id = :id");
                $update_stmt->bindParam(':name_up', $p_name);
                $update_stmt->bindParam(':detail_up', $p_detail);
                $update_stmt->bindParam(':price_up', $p_price);
                $update_stmt->bindParam(':file_up', $image_file);
                $update_stmt->bindParam(':id', $p_id);
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="txt_name" class="form-control" value="<?php echo $p_name; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="txt_detail" class="form-control" value="<?php echo $p_detail; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="number" name="num_price" class="form-control" value="<?php echo $p_price; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
