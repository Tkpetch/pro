<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $insert_stmt = $db->prepare('INSERT INTO tbl_product(p_name,p_detail,p_price,image) VALUES (:fname,:fdetail,:fprice,:fimage)');
                $insert_stmt->bindParam(':fname', $p_name);
                $insert_stmt->bindParam(':fdetail', $p_detail);
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="number" name="num_price" class="form-control" placeholder="Enter Price">
            </div>
            </div>
        </div>
        <div class="form-group">
